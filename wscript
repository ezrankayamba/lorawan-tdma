...
def build(bld):
    module = bld.create_ns3_module('lorawan-tdma', ['core', 'network',
    ...
    module.source = [
        ...
        'model/tdma.cc',
        'model/tdma-lorawan-rtc.cc',
        'model/tdma-rtc-trailer.cc',
        'model/tdma-dev-trailer.cc',
        'model/tdma-sender.cc',
    ...
    headers.source = [
        ...
        'model/tdma.h',
        'model/tdma-lorawan-rtc.h',
        'model/tdma-rtc-trailer.h',
        'model/tdma-dev-trailer.h',
        'model/tdma-sender.h',
